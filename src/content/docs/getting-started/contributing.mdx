...
<Card title="Images">
Image files should be named with the format `XX-kebab-case-name`, where the two first characters and the unique (within a lesson/guide) ID of the image.
...
For example, if there were 2 images in a lesson at `src/assets/content/docs/lessons/101-kebab-eating.mdx`, some image files could be:
```
src/assets/lessons/101-kebab-eating/01-grill-photo.png
src/assets/lessons/101-kebab-eating/02-propane-tank.png
```
</Card>
